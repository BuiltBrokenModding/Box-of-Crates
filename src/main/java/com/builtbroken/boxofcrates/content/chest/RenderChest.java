...
{
    public static final ResourceLocation textureDoubleChest = new ResourceLocation(BoxOfCrates.DOMAIN, "textures/entity/chest/grey_scale_double.png");
    public static final ResourceLocation textureChest = new ResourceLocation(BoxOfCrates.DOMAIN, "textures/entity/chest/grey_scale.png");
